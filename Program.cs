   ...
   internal class Program
   {
      static void Main(string[] args)
      {
         double[,] number =
         {
            ...
            {6.00, 2.99, -72.07, -7.00, 15.44, 57.75, 15.24, -98.13, 73.88, 66.98},
            {7.00, -33.08, -69.47, -46.32, -20.73, -42.17, -19.94, -66.76, 23.69, 83.48 },
            {8.00, 74.65, 60.43, -64.11, -6.15, 81.22, -70.96, 42.83, -75.85, -97.70 },
